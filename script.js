...
function updateGreeting() {
    let userName = "ADAM";  // Later, get the actual user’s name from database
...
// leave bar
const leaveTaken = 25; // Test variable, later fetch from database
const maxLeave = 25;
